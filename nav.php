...
<nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #1a237e; box-shadow: 0 2px 4px rgba(0,0,0,.1);">
    <div class="container">
        <a class="navbar-brand" href="/matthew/1/all" style="font-family: 'Lora', serif; font-weight: 700; font-size: 1.5rem;">HistoricalChristian.Faith</a>
        ...
        <div class="collapse navbar-collapse" id="mainNavbar">
            <ul class="navbar-nav ms-auto">
                <li class="nav-item">
                    <a class="nav-link<?= $current_page === 'bible' ? ' active' : '' ?>" href="/matthew/1/all">Bible</a>
                </li>
                <li class="nav-item">
