  ...
  <ion-header>
    ...
    <ion-toolbar>
        <form method='GET' action='?' onsubmit="window.location.href='commentaries.php?search_query='+$('#search_query').val();return false;">
            <ion-searchbar placeholder="Matthew 1:1" id="search_query"></ion-searchbar>
        </form>
...
<ion-card>
    ...
    <ion-card-content>
<i>"Every age has its own outlook. It is specially good at seeing certain truths and specially liable to make certain mistakes. We all, therefore, need the books that will correct the characteristic mistakes of our own period. And that means the old books.
<br><br>
...
<br><br>
To be sure, the books of the future would be just as good a corrective as the books of the past, but unfortunately we cannot get at them."</i>
<br><br>
– <b><a href='https://web.archive.org/web/20070222105839/https://www.spurgeon.org/~phil/history/ath-inc.htm' target='_blank'>C. S. Lewis</a></b>
<br><br>
...
/*
    ...
    - Jordan Peterson, Joe Rogan Experience #1070, timestamp 1:06:49, https://youtu.be/6T7pUEZfgdI?t=4009

I use Biblehub the same way, and love it. But... its commentaries are mostly post-Reformation, within the last 500 years. What of Christian interpretation from the last 1500 years before then? Thus this site

https://tollelege.net/2008/11/14/read-old-books-by-cs-lewis/
*/
?>
    </body>
</html>